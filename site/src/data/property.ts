...
export const property = {
  ...
  commonAreas: [
    { src: "/images/condominio/piscina-climatizada.webp", alt: "Piscina climatizada com borda infinita e vista para a cidade", label: "Piscina climatizada", width: 640, height: 348 },
